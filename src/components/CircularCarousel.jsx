...
const PlanetCarousel = () => {
  ...
  return (
    <div className="relative h-[1000px] w-full flex items-center justify-center z-20">
      {/* Perspective Container - Kept inner to avoid distortion when moving the section */}
      <div className="relative w-full h-full flex items-center justify-center [perspective:1500px]" style={{ transformStyle: 'preserve-3d' }}>
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          ...
                          <motion.div
                            className="relative w-24 h-24 rounded-full bg-white border border-white/20 flex items-center justify-center"
                            style={{
